  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Los siguientes proyectos muestran mis habilidades y experiencia a través de ejemplos del mundo real. Cada proyecto se describe brevemente, con enlaces a repositorios de código y demostraciones en vivo. Algunas de las tecnologías utilizadas fueron Javascript (React) en el Frontend y Java (Spring) en el Backend, al igual que herramientas como Tailwind, entre otras.
        </motion.p>
      </div>
